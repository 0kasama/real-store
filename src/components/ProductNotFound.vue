...
<template>
  <div class="flex flex-col w-full justify-center items-center gap-5 relative">
    ...
    <p>{{ error }}</p>
    <div class="z-10 flex flex-row w-full justify-center gap-5">
      <button
        @click="nextProduct"
        class="btn btn-neutral hover:bg-neutral btn-outline w-2/5 text-2xl"
      >
        Next Product
      </button>
    </div>
